          ...
          <div className={styles.eventDetail}>
            <div className={styles.eventTime}>
              <p>
                ...
                {calendar && calendar.event && calendar.event.real_category}
                <br />
                {formatMessage({
            ...
            <div className={styles.eventLocation}>
              ...
              <p className="hihi">
                ...
                {
                  // (calendar.m_location_id === PHONE_M_LOCATION_ID ||
                  //   calendar.m_location_id === LOCATION_M_LOCATION_ID ||
                  //   calendar.m_location_id === OTHER_M_LOCATION_ID)
                  //   &&
