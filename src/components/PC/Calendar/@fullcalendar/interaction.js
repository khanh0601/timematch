...
var DateSelecting = /** @class */ (function(_super) {
  ...
  function DateSelecting(settings) {
    ...
    _this.handlePointerDown = function(ev) {
      ...
      var canSelect =
        options.selectable && component.isValidDateDownEl(ev.origEvent.target);
  ...
  function EventDragging(settings) {
    ...
    _this.handleHitUpdate = function(hit, isFinal) {
      ...
      if (!isFinal) {
        ...
        _this.dragging.setMirrorIsVisible(
          !hit || !getElRoot(_this.subjectEl).querySelector('.fc-event-mirror'),
        );
    ...
    _this.handleDragEnd = function(ev) {
      if (_this.isDragging) {
        ...
        if (validMutation && validMutation.datesDelta) {
          obj.delta = validMutation.datesDelta;
        }
        console.log('obj: ', obj);
        initialContext_1.emitter.trigger('eventDragStop', obj);
        if (validMutation) {
