...
※投票日時で〇が一番多い日時の背景が「緑色」になっています。`,
  ...
  i18n_signin_google: 'Googleでログイン',
  i18n_signin_office: 'Microsoftでログイン',
...
例：秘書や営業アシスタントによるミーティング参加者の日程設定、インサイドセールスメンバーによるフィールドセールスメンバーの日程調整`,
  ...
  i18n_calendar_link_other_google: 'Googleでログイン',
  i18n_calendar_link_other_microsoft: 'Microsoftでログイン',
  i18n_register_link: '利用登録は',
  i18n_left_signup_title: 'アカウント新規作成',
